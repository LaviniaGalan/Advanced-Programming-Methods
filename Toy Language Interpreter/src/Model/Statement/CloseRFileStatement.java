...
public class CloseRFileStatement implements IStatement{
    ...
    public ProgramState execute(ProgramState programState) throws Exception {
        ...
        {
            throw new FileException("The file " + expressionValueString + " was never opened.\n");
        }

        BufferedReader reader = programState.getFileTable().lookup(expressionValueString);
        try{
            reader.close();
            programState.getFileTable().delete(expressionValueString);
        }
        catch (Exception e)
        {
            throw  new FileException("The file " + expressionValueString + " could not be closed.");
        }
    ...
    public MyIDict<String, IType> typeCheck(MyIDict<String, IType> typeEnv) throws Exception
    {
        ...
        if (! expressionType.equals(new StringType()))
            throw new InvalidType("Close File: Expression is not a string!\n");
        return typeEnv;
    }
